...
import { deleteGalleryImg, getGallery, replaceGalleryImage } from '../../redux/Action/PropertyTypeAction';
                ...
                <div className="card-header ">
                  ...
                  {editImage
                    ...
                    :
                      ...
                      <img
                        src={!isImgReplaced?`${process.env.REACT_APP_API_BASE_URL}/${image}`:
                        `${process.env.REACT_APP_API_BASE_URL}/${gallery_imgs_for_preview[0]?.gallery_img[index]}`}
                        alt="preview"
                        style={{
                          width:"200px",
                          //   width: "120%",
