...
export default function Editors() {
    ...
    const { users, college, tab_status } = useSelector(state => ({
        ...
        college: state?.propertyType?.college.filter(item => item?.propertyManagerId == sessionStorage.getItem("userId") && item?.edu_type == "University"),
    ...
    return (
        <div>
            <div className="page-header">
                <div>
                    <h1 className="page-title">My University Property List</h1>
                    <Breadcrumb className="breadcrumb">
                        <Breadcrumb.Item className="breadcrumb-item" href="#">
                            Property
                        </Breadcrumb.Item>
                        <Breadcrumb.Item className="breadcrumb-item active breadcrumds" aria-current="page">
                            My University Property List
                        </Breadcrumb.Item>
                    </Breadcrumb>
                </div>
            </div>
            ...
            <Row className=" row-sm">
                <Col lg={12}>
                    <Card>
                        <Card.Header>
                            <h3 className="card-title">My University Property List</h3>
                        </Card.Header>
                        <Card.Body>
                            <div className="table-responsive">
                                <datatable.MyUniversityProrpertyListTable
