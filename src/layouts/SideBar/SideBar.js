...
const Sidebar = () => {
  const MENU = ["9"].includes(sessionStorage.getItem("role")) ? SUPERADMINMENUITEMS : ["1"].includes(sessionStorage.getItem("role")) ? PROPERTYMANAGERMENUITEMS : ["2"].includes(sessionStorage.getItem("role")) ? EDITORMENUITEMS : MENUITEMS;
