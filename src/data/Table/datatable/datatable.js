...
export const EditorTeamLeaderDataTables = ({
  handleShow,
  handleStatusUpdate,
  handleOpenUserModal,
  teamLeaders,
    ...
    // },
    {
      ...
      cell: (row) => (
        <span className="" style={{ width: "409px" }}>
          ...
          <OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
            <NavLink
              to={`/update_editorTeamList/${row._id}`}
              className="btn btn-primary btn-sm rounded-11 me-2"
            >
              <i>
                <svg
...
export const MyUniversityProrpertyListTable = ({
  handleShow,
  tab_status,
  handleStatusUpdate,
  handleClickOpen,
...
export const CollegeProrpertyListTable = ({
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row) => (
        <span className="" style={{ width: "409px" }}>
          {permission?.collegeView == true || Object.keys(permission) == false ?
            <OverlayTrigger placement="top" overlay={<Tooltip>View</Tooltip>}>
              <NavLink
                to={`/property-list/${row._id}/${row.edu_type}`}
                className="btn btn-yellow btn-sm rounded-11 me-2"
          ...
          {permission?.collegeUpate == true || Object.keys(permission) == false ?
            <OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
              <NavLink
                to={`/update-propertys/${row._id}`}
                className="btn btn-primary btn-sm rounded-11 me-2"
...
export const CollegeProrpertyListForWebSiteTable = ({
  handleShow,
  tab_status,
  handleStatusUpdate,
  handleClickOpen,
...
export const CollegeLogoProrpertyListForWebSiteTable = ({
  handleShow,
  tab_status,
  handleStatusUpdate,
  handleClickOpen,
...
export const UniversityProrpertyListForWebSiteTable = ({
  handleShow,
  tab_status,
  handleStatusUpdate,
  handleClickOpen,
...
export const UniversityLogoProrpertyListForWebSiteTable = ({
  handleShow,
  tab_status,
  handleStatusUpdate,
  handleClickOpen,
...
export const DataTablesForProperty = ({
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row) => (
        <span className="">
          {permission?.propertyTypeUpdate == true || Object.keys(permission) == false ?
            <OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
              <Link
...
export const DataTablesForStatus = ({
  ...
  const columns = [
    ...
    // },
    {
      ...
      cell: (row) => (
        <span className="">
          {permission?.statusUpate || Object.keys(permission) == false ?
            <OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
              <Link
          ...
          {permission?.statusDelete || Object.keys(permission) == false ?
            <OverlayTrigger placement="top" overlay={<Tooltip>Delete</Tooltip>}>
              <Link
                onClick={
                  handleShow(row?._id)
